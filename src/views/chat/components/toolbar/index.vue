...
const goRoleRepository = () => {
  router.push('/roleRepository')
}
...
<template>
  <div class="mt-2 space-y-2 border-t p-4 dark:border-t-neutral-800">
    ...
    <NButton style="width: 100%" @click="clearData">
      清空对话
    </NButton>
  </div>
</template>
